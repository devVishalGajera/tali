...
function LoginForm() {
  ...
  const inputBase = (name: keyof Fields) =>
  ...
  return (
    <>
      ...
      <div className="text-center mb-8">
        <h1 className="text-[26px] font-bold text-[#1A2E22] leading-tight mb-2">Welcome back</h1>
        <p className="text-sm text-gray-400">Sign in to your Talli account to continue.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} noValidate className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <Link
              ...
              className="text-xs text-[#006B4D] font-medium hover:underline"
            >
              Forgot password?
            </Link>
          </div>
        ...
        <label className="flex items-center gap-2.5 cursor-pointer select-none w-fit">
          ...
          <span className="text-sm text-[#1D1D1D]">Remember me</span>
        </label>
        ...
        <button
          ...
          className="w-full py-3.5 bg-[#1A3D2B] hover:bg-[#14311f] active:scale-[0.99] text-white font-semibold text-sm rounded-xl transition-all disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-sm"
        >
          {loading ? (
