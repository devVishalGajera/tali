...
const ProductCarouselSection = ({
  ...
  return (
    <section className="mb-6 md:mb-10 overflow-x-hidden">
      ...
      <div className="overflow-x-hidden overflow-y-hidden -mx-4 sm:-mx-6 md:-mx-8 px-4 sm:px-6 md:px-8 mt-3 py-6">
        <Swiper
          modules={[FreeMode]}
          freeMode={true}
          spaceBetween={16}
