...
const Footer = () => {
  ...
  const infoLinks = ["FAQ", "About Us", "Customer Support", "Locations"];

  const myChoiceLinks = ["Favorites", "My Orders"];
        ...
        <div className="hidden md:block">
          <div className="grid grid-cols-5 gap-8 lg:gap-12 mb-8">
            ...
            <div className="col-span-1">
              ...
              <p className="text-base font-semibold mb-4">+91 7779027171</p>
